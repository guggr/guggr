...
ADD FOREIGN KEY ("role_id") REFERENCES "role" ("id") ON UPDATE CASCADE ON DELETE SET DEFAULT;

ALTER TABLE "user_group_mapping"
ADD FOREIGN KEY ("group_id") REFERENCES "group" ("id") ON UPDATE CASCADE ON DELETE RESTRICT;
...
ALTER TABLE "job"
ADD FOREIGN KEY ("group_id") REFERENCES "group" ("id") ON UPDATE CASCADE ON DELETE CASCADE;

ALTER TABLE "job"
ADD FOREIGN KEY ("job_type_id") REFERENCES "job_type" ("id") ON UPDATE CASCADE ON DELETE RESTRICT;
