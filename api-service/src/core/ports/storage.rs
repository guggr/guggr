...
pub trait Crud<T> {
    ...
    async fn update(&self, id: &str, update_value: T) -> Result<(), StorageError>;
    async fn get_by_id(&self, id: &str) -> Result<T, StorageError>;
    async fn delete(&self, id: &str) -> Result<(), StorageError>;
    async fn list(&self, limit: i64) -> Result<Vec<T>, StorageError>;
}

#[async_trait]
pub trait StoragePort: Crud<Group> + Send + Sync {}
