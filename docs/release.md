...
The helm chart release is released semi-automatically via this [github action](https://github.com/guggr/guggr/actions/workflows/release-chart.yaml). It is _not_ managed with Release-please since it doesn't work that well.
